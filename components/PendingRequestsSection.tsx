...
export default function PendingRequestsSection() {
  ...
  if (loading) {
    return (
      <div className="bg-white rounded-2xl shadow-md p-6">
        <h2 className="text-xl font-bold text-gray-800 mb-4">Pending Equipment Requests</h2>
  ...
  if (error) {
    return (
      <div className="bg-white rounded-2xl shadow-md p-6">
        <h2 className="text-xl font-bold text-gray-800 mb-4">Pending Equipment Requests</h2>
        <div className="text-sm text-red-600 bg-red-50 p-3 rounded">Could not load requests: {error}</div>
      </div>
    )
  }
  ...
  if (requests.length === 0) {
    return (
      <div className="bg-white rounded-2xl shadow-md p-6">
        <h2 className="text-xl font-bold text-gray-800 mb-4">Pending Equipment Requests</h2>
        <div className="text-sm text-gray-500 italic">No pending equipment requests at this time.</div>
      </div>
    )
  }
  ...
  return (
    <div className="bg-white rounded-2xl shadow-md p-6">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-xl font-bold text-gray-800">Pending Equipment Requests ({requests.length})</h2>
      </div>
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-semibold text-blue-600 hover:underline">{req.key}</p>
                  <p className="text-sm text-gray-700 mt-1">{req.summary}</p>
                ...
                <span className="px-3 py-1 rounded-full text-xs font-medium whitespace-nowrap bg-orange-100 text-orange-700">
                  {req.status}
                </span>
              </div>
            </Link>
