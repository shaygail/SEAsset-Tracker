...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center mt-10 gap-8 px-2 w-full">
      <div className="text-center w-full">
        <h1 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-2">Asset Lookup</h1>
        <p className="text-gray-500 text-base">Enter an asset tag or object key to jump straight to an asset</p>
      </div>
      ...
      <form
        ...
        className="bg-white rounded-2xl shadow-lg p-6 w-full flex flex-col gap-5 border border-gray-100"
      >
        ...
        <input
          ...
          className="border border-gray-300 rounded-xl px-4 py-3 text-base focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder:normal-case bg-gray-50"
          autoFocus
          autoComplete="off"
          spellCheck={false}
        />
        ...
        <button
          type="submit"
          className="bg-blue-700 hover:bg-blue-800 text-white font-semibold rounded-lg py-3 transition-colors"
        >
          View Asset →
        </button>
      </form>
      ...
      <div className="flex flex-col items-center gap-2 text-center">
        ...
        <Link
          href="/dashboard"
          className="flex items-center gap-2 bg-white border border-gray-200 hover:border-blue-400 hover:text-blue-700 text-gray-700 font-semibold rounded-xl px-6 py-3 shadow-sm transition-colors text-sm"
        >
